					...
					$.each($('.animation'), function() {
						...
						if(self.isScrolledIntoView($element)) {
							...
							if ($element.hasClass("view")) {
								...
								self.slideLeft(self.$container.find(".view.slideLeft"),self.settings.left);

								self.slideRight(self.$container.find(".view.slideRight"),self.settings.right);

								self.slideTop(self.$container.find(".view.slideTop"),self.settings.left);

								self.slideBottom(self.$container.find(".view.slideBottom"),self.settings.right);
								
								self.fadeIn(self.$container.find(".view.fadeIn"),self.settings.fadeDelay);
